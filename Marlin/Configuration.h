...
#define STRING_CONFIG_H_AUTHOR "(Merlin Webster, Saxon config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Saxon"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 395.5 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 61.5, 16, -2.3}
